...
const ExportForm = ({
  ...
  return (
    <form className="border border-[#074EE8] p-4 rounded-lg mb-6 mt-3">
      <div className="grid gap-y-4 sm:mb-5">
        <CustomSelectField
          label="Mã sản phẩm"
          name="product_id"
          options={productOptions}
          value={exportFormData.product_id}
          onChange={onChange}
        />
        ...
        <CustomSelectField
          ...
          value={exportFormData.user_id}
          onChange={onChange}
        />
      </div>
      <div className="flex flex-col items-center">
        <hr className="w-full my-4 border-gray-300 mt-4 sm:mt-16" />
